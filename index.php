        ...
        <div class="row" data-aos="fade-down" data-aos-duration="2000">
          <div class="col-lg-4" >
            ...
            >
              ...
              <h2 class="text-cursive font-effect-3d">Çocuklara Uygun</h2>
              <p class="font-size-20">İçeriklerimiz çocuklara uygun bir biçimde uzman Pedagoglar eşliğinde hazırlanmıştır.</p>
            </div>
          </div>
          <div class="col-lg-4" >
            <div class="block-2 yellow" style="box-shadow: 0px 28px 14px 0px rgba(0,0,0,0.1);"
            >
              <span class="wrap-icon">
          ...
          <div class="col-lg-4">
            <div class="block-2 teal" style="box-shadow: 28px 28px 14px 0px rgba(0,0,0,0.1);"
            >
              <span class="wrap-icon">
                <span class="icon-cog"></span>
              </span>
              <h2 class="text-cursive font-effect-3d">Sınav Sistemi</h2>
              <p class="font-size-20">İçeriklerimizdeki sınav sistemi sayesinde çocuklar bilgilerini ölçebilecektir. </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          data-aos-duration="3000">
            ...
            <!-- <p class="mt-5"><a href="#" class="btn btn-warning py-4 btn-custom-1 text-cursive font-effect-3d-float">Daha Fazla</a></p> -->
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0" >
            ...
            data-aos-duration="2000">
              ...
              <!-- <p><a href="#" class="btn btn-primary btn-custom-1 mt-4 text-cursive font-effect-3d-float">Daha fazla</a></p> -->
            </div>
          </div>
          <div class="col-lg-4 mb-4 mb-lg-0">
